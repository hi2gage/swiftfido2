...
extension FidoDevice {
	...
	static let CTAP_CID_BROADCAST = 0xffff_ffff
	static let CTAP_INIT_HEADER_LEN = 7
	static let CTAP_CONT_HEADER_LEN = 5

	/* Maximum length of a CTAP HID report in bytes. */
	static let CTAP_MAX_REPORT_LEN = 64

	/* Minimum length of a CTAP HID report in bytes. */
	static let CTAP_MIN_REPORT_LEN: Int = CTAP_INIT_HEADER_LEN + 1

	/* CTAPHID command opcodes. */

	static let CTAP_CMD_INIT = 0x06
}
